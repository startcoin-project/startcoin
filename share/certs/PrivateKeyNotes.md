...
unlocked to sign the StartCOIN-Qt.app bundle.
...
allowing somebody to distribute a StartCOIN-Qt.app or startcoin-qt-setup.exe with a valid
...
that the startcoin-qt.exe file inside the installer had not been tampered with.
