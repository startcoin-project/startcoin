...
In order to support loading of multiple wallets in startcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, three new headers and source files will have to be added to startcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into startcoin-qt, and as such, will require some minor modifications to provide hooks for
